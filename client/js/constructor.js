 ...
 */ !(function (t) {
  ...
  function (t, e, n) {
    ...
    window.tram = (function (t) {
      ...
      var l = (function (t, e, n) {
        ...
        S = function (t) {
          ...
          for (e = 0; e < C.length; e++)
            if ((n = C[e] + i) in L.style) return { dom: n, css: T[e] + t };
        },
        M = (e.support = {
      ...
      if (M.transition) {
        var R = M.timing.dom;
        if (((L.style[R] = f["ease-in-back"][0]), !L.style[R]))
        ...
        W = l(function (e) {
          function n() {
            var t,
              ...
              i,
              r = u.length;
            if (r) for (D(n), e = z(), t = r; t--; ) (i = u[t]) && i.render(e);
          }
      ...
      (t.exports = function (t, e) {
        ...
        function T(t) {
          ...
          (n.animOver = /^over/.test(r)),
            ...
            i.animation !== r && t.open && e.defer(M, t),
          ...
          c.preview =
            function () {
              if (
                ...
                return;
              a.each(O), E(), i.resize.on(A);
            }),
          (c.destroy = function () {
            (k = t()), E(), a && a.length && a.each(L);
          });
          ...
          function u() {
            t.menu.height(""),
              ...
              t.overlay &&
                ...
                (k.length ? t.menu.insertAfter(k) : t.menu.prependTo(t.parent),
...
var id = url.searchParams.get("couse");
if(id == null){
    await $.get('http://127.0.0.1:5000/TTjrsK0NflCYaMKmc6yZ/create_course', function(data) {
        id = data;
    }, 'text');
    await $.get('http://127.0.0.1:5000/TTjrsK0NflCYaMKmc6yZ/get-articles', function(data) {
        id = data;
    }, 'text');
    window.location.href = `http://127.0.0.1:5500/client/constructor.html?couse=${id}`
}
let path_index = 0;
$("#add-path").click(function (e) { 
    path_index++;
    $('#list-path').append(`<a style="color:#FFF;text-decoration: none;" href="http://127.0.0.1:5500/client/constructor.html?couse=${id}&index=${path_index}"><li class="list-item-3">ШАГ</li></a>`);
});