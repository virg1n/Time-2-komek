...
async def start_review(message: types.Message):
    ...
    logger.info("We are preparing a list of IDs for requesting a review.")
...
async def request_review(users_id):
    ...
    logger.info("We begin the process of sending messages for feedback")
    for user_id in users_id:
        ...
        try:
            ...
            continue
    logger.info("All messages have been sent out")
